...
namespace Secyud.Abp.AspNetCore.Components.Server.MasaTheme.Demo
{
    ...
    public class MasaThemeDemoModule : AbpModule
    {
        public override void ConfigureServices(ServiceConfigurationContext context)
        {
            ...
            {
                options.MenuContributors.Add(new MasaThemeDemoMenuContributor());
            });

            Configure<AbpRouterOptions>(options =>
            {
                options.AppAssembly = typeof(MasaThemeDemoModule).Assembly;
            });
        ...
        public override void OnApplicationInitialization(Volo.Abp.ApplicationInitializationContext context)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "Aps API");
            });
