...
public class ClientDemoService : ITransientDependency
{
    ...
    public ClientDemoService(
        ICodeClassAppService codeClassAppService,
    ...
    private async Task TestWithDynamicProxiesAsync()
    {
        ...
        Console.WriteLine("Result Description(authorized): " + result.Description);
    }
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url = _configuration["RemoteServices:CodeDocs:BaseUrl"] +
                      "api/CodeDocs/sample/authorized";
